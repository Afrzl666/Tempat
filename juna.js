...
function title() {
console.log(chalk.bold.green(figlet.textSync('notfound Bot', {
font: 'Standard',
...
pathFile = await writeExif(media, { packname: options.packname ? options.packname : 'notfound-MD', author: options.author ? options.author : '+6285931248430', categories: options.categories ? options.categories : [] })
